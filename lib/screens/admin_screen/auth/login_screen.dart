...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Future.microtask(() {
    //   debugPrint("Initializing app info...");
    //   AppInfoPreference().init();
    //   setStateIfMounted(() {
    //     projectName = AppInfoPreference().getAppName().toString();
    //     projectVersion = AppInfoPreference().getAppVersion().toString();
    //   });
    // });
    return _showData
        ? Scaffold(
